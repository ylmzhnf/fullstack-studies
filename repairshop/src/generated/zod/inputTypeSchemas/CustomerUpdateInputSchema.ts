...
import { TicketUpdateManyWithoutCustomerNestedInputSchema } from './TicketUpdateManyWithoutCustomerNestedInputSchema';
...
export const CustomerUpdateInputSchema: z.ZodType<Prisma.CustomerUpdateInput> = z.strictObject({
  ...
  tickets: z.lazy(() => TicketUpdateManyWithoutCustomerNestedInputSchema).optional(),
});
