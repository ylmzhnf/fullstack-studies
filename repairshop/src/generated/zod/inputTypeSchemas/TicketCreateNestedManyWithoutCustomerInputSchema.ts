...
export const TicketCreateNestedManyWithoutCustomerInputSchema: z.ZodType<Prisma.TicketCreateNestedManyWithoutCustomerInput> = z.strictObject({
...
export default TicketCreateNestedManyWithoutCustomerInputSchema;
