...
import { CustomerUpdateOneRequiredWithoutTicketsNestedInputSchema } from './CustomerUpdateOneRequiredWithoutTicketsNestedInputSchema';
...
export const TicketUpdateInputSchema: z.ZodType<Prisma.TicketUpdateInput> = z.strictObject({
  ...
  customer: z.lazy(() => CustomerUpdateOneRequiredWithoutTicketsNestedInputSchema).optional(),
});
